...
public class Configuration {
    ...
    public static final Scene STARTING_SCENE = DefinedScenes.getSceneByName("testActorSprites"); // Scene awal
    public static final int WINDOW_WIDTH_PIXELS = 1280;        // Lebar window
